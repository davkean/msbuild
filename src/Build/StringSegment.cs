...
// Taken from https://github.com/aspnet/Common/.
//
// Once CoreFX adds Span<T>/Memory<T>/StringSegment type we can start to use that:
// https://github.com/dotnet/corefx/issues/20378
...
namespace Microsoft.Build
{
    ...
    /// </summary>
    internal struct StringSegment : IEquatable<StringSegment>, IEquatable<string>
    {
        /// <summary>
        ...
        private static Exception GetInvalidArgumentException(string buffer, int offset, int length)
        {
            ...
            return new ArgumentException("offset");
        }
